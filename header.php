...
<head>
   ...
   <?php include 'titulosDescricoes.php' ?>
    ...
    <script src="/ComboV2/js/jquery-3.2.0.min.js"></script>
    ...
    <link rel="stylesheet" href="/ComboV2/css/flexslider.css" />
    <link rel="stylesheet" href="/ComboV2/css/remodal.css">
    <link rel="stylesheet" href="/ComboV2/css/remodal-default-theme.css">
   
    <link rel="stylesheet" href="/ComboV2/css/site.css">
...
<body>
                ...
                <div class="logo col-md-4">
                    <?php if($paginaPrincipal) { ?>
                        <h1 title="GVT | Vivo Combo com TV, Internet Banda Larga e Telefonia Fixa, GVT Contato">
                            <a href="/"><img src="/ComboV2/img/vivo-logo.png" alt="Vivo Logo" /></a>
                        </h1>
    ...
    <div class="row">
        <div class="flexslider col-lg-12 col-md-12 col-sm-12">
            <ul class="slides">
                <li>
                    <img src="/ComboV2/img/vivoPrecoss.jpg" />
                    <!--<p class="flex-caption">Adventurer Cheesecake Brownie</p>-->
                </li>
                <li>
                    <img src="/ComboV2/img/vivo-TV.jpg" />
